...
| **Commit** | `6c6d7bb` (utility), `f4bb16a` (driver), `f146a9f` (docs), `793a67e` (Windows host path), `0ac80f9` (lexical Windows strings), `dbe4001`/`0158de9` (replay closure metadata); tip `5088a9c` (review follow-up) |
